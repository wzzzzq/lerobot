...
class VLAFlowMatching(nn.Module):
    ...
    def generate_reflow_target(self, images, img_masks, lang_tokens, lang_masks, state, noise):
        ...
        This implements the data pair generation step in Reflow:
        X_0 ~ N(0, 1) (noise)
        X_1 = ODE[v_k](X_0 | T) (generated by teacher model)
        ...
        Returns:
            X_1: Generated actions from teacher model
        """
        ...
        num_steps = self.config.reflow_num_inference_steps
        dt = -1.0 / num_steps  # negative because going from 1 to 0
